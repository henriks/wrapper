...
pub trait FileSystem {
    ...
    /// Query for a conflicting POSIX byte-range lock.
    fn getlk(
        &self,
        ctx: Context,
        inode: Self::Inode,
        ...
        let _ = (ctx, inode, handle, owner, lock, flags);
        Err(io::Error::from_raw_os_error(libc::ENOSYS))
    }

    /// Set or clear a non-blocking POSIX byte-range lock.
    fn setlk(
        &self,
        ctx: Context,
        inode: Self::Inode,
    ...
    /// Set or clear a blocking POSIX byte-range lock.
    fn setlkw(
        &self,
        ctx: Context,
        inode: Self::Inode,
